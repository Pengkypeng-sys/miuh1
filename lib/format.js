...
export const TAB_META = {
  ...
  rekap: { title: 'Dashboard', desc: 'Ringkasan pembayaran seluruh kelas', icon: 'chart' },
  akun: { title: 'Akun Saya', desc: 'Ganti password login', icon: 'lock', group: 'akun' },
};

// Menu di sidebar yang dikelompokkan jadi 1 dropdown (biar sidebar gak numpuk panjang ke bawah)
export const NAV_GROUPS = [
  { key: 'admin', label: 'Administrasi', icon: 'settings', tabs: ['siswa', 'item', 'kenaikan'] },
  { key: 'akun', label: 'Akun', icon: 'userPlus', tabs: ['akun'] },
];
...
export const PPDB_HARGA_ACUAN = { '1-L': 940000, '2-L': 1055000, '3-L': 1175000, '1-P': 1035000, '2-P': 1165000, '3-P': 1295000 };
...
// SPP beda target per kelas (KELAS 1 lebih mahal) — item_pembayaran cuma punya 1 target flat, jadi dipisah di sini.
export const SPP_TARGET_PER_KELAS = { 'KELAS 1': 70000, 'KELAS 2': 60000, 'KELAS 3': 60000, 'KELAS 4': 60000, 'KELAS 5': 60000, 'KELAS 6': 60000 };
...
export const KATEGORI_PENGELUARAN = ['ATK', 'Konsumsi', 'Kebersihan', 'Operasional', 'Lainnya'];
...
// Label singkat dari User-Agent buat riwayat login — bukan parser lengkap, cukup buat "Chrome di Android" dkk.
export function parseUaSingkat(ua) {
