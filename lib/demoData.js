...
export const DEMO_REKAP = {
  ...
  piutang: [
    { kelas: 'KELAS 3', siswa: 'Dewi Lestari', kurang: 420000, items: [{ nama: 'SPP', kurang: 210000 }, { nama: 'BUKU', kurang: 210000 }] },
    { kelas: 'KELAS 1', siswa: 'Rian Saputra', kurang: 300000, items: [{ nama: 'PPDB', kurang: 300000 }] },
    { kelas: 'KELAS 5', siswa: 'Putri Ayu', kurang: 150000, items: [{ nama: 'SPP', kurang: 150000 }] },
  ],
};
