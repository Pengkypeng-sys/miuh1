    ...
    <div className="bayar-grid">
      ...
      {kas && kas.rekapBulanan && (
        <div className="panel panel-print">
          <details className="collapsible">
            <summary className="panel-title"><span className="ic-badge"><Icon name="chart" size={14} /></span> Rekap Keuangan Bulanan</summary>
            <div className="panel-desc no-print" style={{ marginBottom: 10 }}>Masuk, keluar & saldo per bulan — 6 bulan terakhir</div>
